      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 font-semibold">Welcome back! Login to your account</p>
          </div>
          ...
          <p className="text-center text-gray-700 font-semibold">
            ...
            <Link to="/register" className="bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent font-black hover:underline">
              Register here
            </Link>
          </p>
        </div>
        ...
        <p className="text-center text-gray-500 font-semibold mt-8">
          Save lives by connecting donors with those in need 🩸
        </p>
      </div>
    </div>
  )
